...
***
*** /scripts/shinobi.js - Game functions manager
***
...
Shinobi = function( oApp ) {
    ...
    let game = this, // eslint-disable-line consistent-this
        SmallWall,
        Ennemy,
        EnnemyKunai;
    ...
    // Game over
    this.over = function() {
        let iCurrentScore = this.shinobi.score.current;
